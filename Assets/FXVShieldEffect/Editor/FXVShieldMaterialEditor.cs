...
public class FXVShieldMaterialEditor : ShaderGUI 
{
    ...
    MaterialProperty _BlendSrcModeProperty = null;
    MaterialProperty _BlendDstModeProperty = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        _BlendSrcModeProperty = FindProperty("_BlendSrcMode", props);
        _BlendDstModeProperty = FindProperty("_BlendDstMode", props);
    }
    ...
    public void ShaderPropertiesGUI(Material targetMat)
    {
        ...
        {
            BLEND_MODE_OPTIONS blendModeType = BLEND_MODE_OPTIONS.FXV_ADDITIVE_BLEND;
            if (targetMat.GetInt("_BlendSrcMode") == (int)UnityEngine.Rendering.BlendMode.SrcAlpha &&
                ...
                blendModeType = BLEND_MODE_OPTIONS.FXV_ADDITIVE_BLEND;
            if (targetMat.GetInt("_BlendSrcMode") == (int)UnityEngine.Rendering.BlendMode.SrcAlpha &&
                targetMat.GetInt("_BlendDstMode") == (int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha)
                blendModeType = BLEND_MODE_OPTIONS.FXV_ALPHA_BLEND;
            ...
            if (blendModeType == BLEND_MODE_OPTIONS.FXV_ADDITIVE_BLEND)
            {
            ...
            else if (blendModeType == BLEND_MODE_OPTIONS.FXV_ALPHA_BLEND)
            {
                targetMat.SetInt("_BlendSrcMode", (int)UnityEngine.Rendering.BlendMode.SrcAlpha);
