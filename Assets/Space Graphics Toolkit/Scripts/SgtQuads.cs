	...
	where T : SgtQuads
{
	protected virtual void DrawMaterial(ref bool updateMaterial)
	{
		...
		EndError();
		DrawDefault("BlendMode", ref updateMaterial);
...
public abstract class SgtQuads : MonoBehaviour
{
	...
	[Tooltip("The blend mode used to render the material")]
	public SgtQuadsBlendType BlendMode;

	[Tooltip("The render queue group for this material")]
	public RenderQueue RenderQueue = RenderQueue.Transparent;
	...
	protected virtual void BuildMaterial()
	{
		...
		switch (BlendMode)
		{
			case SgtQuadsBlendType.Additive: BuildAdditive(); break;
			case SgtQuadsBlendType.AlphaTest: BuildAlphaTest(); break;
		}
